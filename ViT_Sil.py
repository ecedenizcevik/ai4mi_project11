...
class ViT_Sil(nn.Module):
    def __init__(self, in_dim: int, out_dim: int, **kwargs):
        ...
        self.patch_embedding = PatchEmbedding(img_size=img_size, patch_size=patch_size, in_channels=in_dim, embed_dim=embed_dim)
    ...
    def init_weights(self, *args, **kwargs):
        pass  # PyTorch's default initialization
